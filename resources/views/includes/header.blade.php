        ...
        <nav class="navbar navbar-expand-lg navbar-dark" aria-label="Navbar" id="nav-menu">
            <div class="container-fluid">
                ...
                <button class="navbar-toggler" id="navbar-toggler" type="button" data-bs-toggle="collapse"
                    ...
                    aria-label="Toggle navigation" alt="Menu Toggle">
                    ...
                    <ul class="navbar-nav nav-justified ms-auto mt-1 mb-0">
                        ...
                        @guest
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="/career" id="dropdown-career"
                                    data-bs-toggle="dropdown-career" aria-expanded="false">CAREER</a>
                                <ul class="dropdown-menu" aria-labelledby="dropdown-career">
                                    ...
                                    <li><a class="dropdown-item" href="/listing">JOB LISTINGS</a></li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="{{ route('account') }}" id="dropdown-career"
                                    data-bs-toggle="dropdown-career" aria-expanded="false">LOGIN</a>
                                <ul class="dropdown-menu" aria-labelledby="dropdown-career">

                                    <li><a class="Signup" id="Signup" href="{{ route('register') }}">REGISTER</a></li>
                                </ul>
                            @endguest
                        ...
                        @auth
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="{{ route('account') }}" id="dropdown-career"
                                    data-bs-toggle="dropdown-career" aria-expanded="false">Account</a>
                                <ul class="dropdown-menu" aria-labelledby="dropdown-career">
                                    @if ($user && $user->role == 1)
                                        <li><a class="dropdown-item" href="{{ route('home') }}">User view</a></li>
                                        <li><a class="dropdown-item" href="{{ route('adminhome') }}">Admin view</a></li>
                                    @endif
